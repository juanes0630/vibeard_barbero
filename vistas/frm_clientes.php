...
$c=new conectar();
$conexion=$c->conexion();
$sql= "SELECT * FROM vta_usuario WHERE tipo_de_usuario = 2";
		...
		<div class="row">			
			<div class="col-sm-9">
				<ul class="nav nav-pills nav-fill ">
					<li class="nav-item">
						<a class="nav-link active btn btn-info" href="frm_clientes.php">CLIENTES</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="frm_barberos.php">BARBEROS</a>
					</li>
				</ul>
			</div>
              ...
              <div class="row">
                ...
                <div class="col-sm-5" align="center">
                  ...
                  <div style="display: inline-flex;">
                    ...
                    <hr style="color: white;border-style: inset;border-width: 1px;width: 10vw;"><img src="../img/facebook.png" style="width: 2.5vw;height: 2.5vw;margin-left: 2vw;margin-right: 2vw;"><hr style="color: white;border-style: inset;border-width: 1px;width: 10vw;">
                  ...
                  <a href="frm_insert_cliente.php" class="btn btn-primary btn-block">AGREGAR</a>
                  <a href="frm_updated_cliente.php?cod=<?php echo $vector[0]; ?>" class="btn btn-info btn-block">EDITAR</a>
                  <a href="../controladores/eliminar_Cliente.php?cod=<?php echo $vector[0]; ?>" class="btn btn-danger btn-block">ELIMINAR</a>
                </div>
